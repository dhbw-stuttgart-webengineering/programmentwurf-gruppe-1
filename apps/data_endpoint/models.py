...
class Unit(models.Model):
    ...
    credits = models.CharField(max_length=200, default=None, null=True)
    average_first_attempt = models.DecimalField(max_digits=2, decimal_places=1,default=0, null=True)
    average_second_attempt = models.DecimalField(max_digits=2, decimal_places=1,default=0, null=True)
